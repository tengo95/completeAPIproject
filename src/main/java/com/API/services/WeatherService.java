...
import com.API.exceptions.DatabaseAccessException;
import com.API.exceptions.ForecastNotFoundException;
import com.API.mappers.WeatherMapper;
import com.API.model.DarkSkyWeather.DayInWeeklyForecast;
import com.API.model.DarkSkyWeather.Forecast;
import com.API.model.DarkSkyWeather.HistoricalDaySummary;
import com.API.model.DarkSkyWeather.HourlyAverage;
import com.API.util.DateUnix;
...
public class WeatherService {
    ...
    public HourlyAverage getCurrentHourlyAverage(double latitude, double longitude) {
        ...
        com.API.model.DarkSkyWeather.Data[] data = forecast.getHourly().getData();
